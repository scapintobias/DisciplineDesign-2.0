				...
				.map((project) => (
					<li className='block w-full list-none'>
						<Link
							...
							className='flex font-light hover:text-charcoal-500'
						>
							<p className='pr-2'>{project.title}</p>-
							<p className='pl-2'>{project.subtitle}</p>
						</Link>
					</li>
				))}
		</>
...
// 							)}`}
// 						>
// 							<div className='p-3 rounded-md bg-blueGray-900 hover:shadow-xl'>
